...
export default async function DetalleClasePage({
  ...
  const isExpress = registro.nota === null && !registro.respondido_at;
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm border border-surface-200">
          ...
          {isExpress ? (
            <div className="flex flex-col items-center justify-center py-6 text-center">
              <span className="inline-flex items-center gap-2 rounded-lg bg-surface-100 px-3 py-1.5 text-sm font-bold text-surface-600 border border-surface-200 mb-2">
                ⚡ Cierre Rápido
              </span>
              <p className="text-sm text-surface-500">
                Esta clase fue cerrada de forma rápida sin evaluación.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
